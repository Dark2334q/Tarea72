...
<head lang="en">
	...
	<link rel="stylesheet" href="bootstrap/css/separate/vendor/select2.min.css">
	...
	<![endif]-->
	<link rel="stylesheet" href="bootstrap/css/lib/bootstrap-table/bootstrap-table.min.css">
	...
	<link rel="stylesheet" href="bootstrap/css/separate/vendor/bootstrap-select/bootstrap-select.min.css">
	<link rel="stylesheet" href="bootstrap/css/separate/vendor/tags_editor.min.css">
	<link rel="stylesheet" href="bootstrap/css/lib/datatables-net/datatables.min.css">
	<link rel="stylesheet" href="bootstrap/css/separate/vendor/datatables-net.min.css">
...
<body class="with-side-menu dark-theme dark-theme-blue">
	<div>
		...
		<?php include "seguridad/config.php"; ?>
		<?php include "encabezado/menu.php"; ?>
	</div>
	<?php include "tablas/t_estudiante.php"; ?>
	<script>
		src = "https://ajax.googleapis.com/ajax/libs/jquery.min.js"
	</script>
	...
	<script src="bootstrap/js/lib/jquery-tag-editor/jquery.tag-editor.min.js"></script>
	<script src="bootstrap/js/lib/bootstrap-select/bootstrap-select.min.js"></script>
	<script src="bootstrap/js/lib/select2/select2.full.min.js"></script>


	<script src="bootstrap/js/lib/datatables-net/datatables.min.js"></script>
